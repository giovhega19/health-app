...
class TimerSettingsTest {
  ...
  void allowsNullFieldsForPartialOverrides() {
    ...
    assertThat(partial.workSeconds()).isNull();
    assertThat(partial.restBetweenSetsSeconds()).isNull();
    assertThat(partial.restBetweenExercisesSeconds()).isNull();
    assertThat(partial.restBetweenRoundsSeconds()).isNull();
