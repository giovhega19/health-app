...
export const strings = {
  ...
  routines: {
    myRoutines: {
      title: "Mis rutinas",
      empty: "Todavía no tienes rutinas propias.",
      createCta: "Crear rutina",
      importCta: "Importar",
      itemsCount: "{{count}} ejercicios",
      durationLabel: "{{minutes}} min",
      predefinedBadge: "Predefinida",
      duplicateCta: "Duplicar y editar",
    },
    editor: {
      title: "Nueva rutina",
      saveCta: "Guardar",
      nameLabel: "Nombre de la rutina",
      missingName: "Falta el nombre de la rutina.",
      missingItems: "Agrega al menos un ejercicio.",
      undoDeleteCta: "Deshacer",
      newExerciseLabel: "Nombre del ejercicio nuevo",
      addItemCta: "Agregar ejercicio",
      removeItemCta: "Quitar",
      cancelCta: "Cancelar",
      savedAnnouncement: "Rutina guardada.",
      duplicatedItemLabel: "Ejercicio {{index}}",
    },
    importPreview: {
      title: "Importar rutina",
      pickCta: "Elegir archivo",
      itemsCount: "{{count}} ejercicios",
      durationLabel: "{{minutes}} min",
      ...
      cancelCta: "Cancelar",
      unsupportedVersion:
        "Esta rutina se creó con una versión más nueva de la app. Actualiza para importarla.",
      invalidFormat: "El archivo no es una rutina válida.",
      fileTooLarge: "El archivo es demasiado grande.",
      genericError: "No se pudo importar la rutina.",
      importedAnnouncement: "Rutina importada.",
    },
  },
  scheduling: {
    notifications: {
      preReminderBody: "Tu rutina empieza pronto.",
      startBody: "Es hora de entrenar.",
      expectedEndBody: "Deberías estar terminando tu rutina.",
      missedBody: "Te perdiste tu rutina programada. Reprograma cuando quieras.",
      postponedTitle: "Recordatorio pospuesto",
    },
    calendar: {
      title: "Mi semana",
      restDay: "Descanso",
      ...
      cancelCta: "Cancelar",
      cancelledAnnouncement: "Horario cancelado.",
      restWarning: "Descanso insuficiente antes de esta rutina (RN-13).",
    },
    permission: {
      deniedTitle: "Las notificaciones están desactivadas",
      deniedMessage: "Actívalas en los ajustes del sistema para recibir tus recordatorios.",
      openSettingsCta: "Abrir ajustes",
    },
    sessionPlaceholder: {
      title: "Disponible próximamente",
      message: "Iniciar la sesión desde aquí llegará pronto.",
    },
  },
} as const;
